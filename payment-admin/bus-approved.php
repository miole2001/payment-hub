            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    if (isset($_GET['delete_id'])) {
                        ...
                        if ($result) {
                            echo "<script>alert('Delete Successful!'); window.location.href = 'bus-approved.php';</script>";
                        } else {
                            echo "<script>alert('Delete Unsuccessful. Error: " . $stmt->error . "'); window.location.href = 'bus-approved.php';</script>";
                        }
                        $stmt->close();
                    }                    
...
<script>
    function confirmDelete(id) {
        if (confirm('Are you sure you want to delete this entry?')) {
            window.location.href = 'bus-approved.php?delete_id=' + id;
        }
    }
</script>
