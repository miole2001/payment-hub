                ...
                <tbody>
                    ...
                    if (isset($_GET['delete_id'])) {
                        ...
                        if ($result) {
                            ...
                            echo "<script>alert('Delete Unsuccessful. Error: " . $stmt->error . "'); window.location.href = 'payment-approved.php';</script>";
                        }
                        $stmt->close();
                    }                    
                    ...
                    $sql = "SELECT * FROM reservation r 
                            ...
                            INNER JOIN tourist t ON t.tour_id = r.tour_id WHERE status = 'approved' AND system_type = 'boat'";
