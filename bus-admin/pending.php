...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['approve_id'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Payment Approved!'); window.location.href = 'pending.php';</script>";
    } else {
        echo "<script>alert('Approval Unsuccessful. Error: " . $stmt->error . "'); window.location.href = 'pending.php';</script>";
    }
                ...
                <tbody>
                    <?php
                        if (isset($_GET['delete_id'])) {
                            ...
                            if ($result) {
                                echo "<script>alert('Delete Successful!'); window.location.href = 'pending.php';</script>";
                            } else {
                                echo "<script>alert('Delete Unsuccessful. Error: " . $stmt->error . "'); window.location.href = 'pending.php';</script>";
                            }
                            $stmt->close();
                        }                    
...
<script>
    function confirmDelete(r_id) {
        if (confirm('Are you sure you want to delete this entry?')) {
            window.location.href = 'pending.php?delete_id=' + r_id;
        }
    }
